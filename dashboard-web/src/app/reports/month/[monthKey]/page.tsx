    ...
    <>
        ...
        actions={
          <div className="flex flex-wrap gap-3">
            <Button asChild variant="outline" className="border-white/10 bg-black/20 text-zinc-100 hover:bg-white/[0.08]">
              <Link href={yearReportHref(report.year)}>חזור לדוח {report.year}</Link>
            </Button>
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <Card className="border-white/8 bg-white/[0.03] p-5 shadow-none">
          ...
          <p className="mt-2 text-sm text-zinc-400">{report.recurringCount} חוזרות, {report.oneTimeCount} חד-פעמיות</p>
        </Card>
        <Card className="border-white/8 bg-white/[0.03] p-5 shadow-none">
          ...
          <p className="mt-2 text-sm text-zinc-400">פריטים עם החלטה ידנית או חריגה</p>
        </Card>
      </section>
